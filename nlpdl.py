...
for lang in ['en', 'nl', 'hu']:
    ...
    jsondict[lang]['P1303'] = jsons
    jsondict[lang]['P27'] = jsons
    ...
    jsondict[lang]['P54'] = jsons
    jsondict[lang]['P27'].extend(jsons)
    ...
    for country in countries:
        ...
        """))
    jsondict[lang]['P449'] = jsons
    jsondict[lang]['P495'] = jsons
    ...
    jsondict[lang]['P159'] = jsons
    jsondict[lang]['P17'] = jsons
